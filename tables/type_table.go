...
var TypesDefinition = map[uint16]*DataType{
	BOOL:    {Input: []uint16{}, Output: []uint16{}, Literal: "bool"},
	INT:     {Input: []uint16{}, Output: []uint16{}, Literal: "int"},
	FLOAT:   {Input: []uint16{}, Output: []uint16{}, Literal: "float"},
	DECIMAL: {Input: []uint16{}, Output: []uint16{}, Literal: "decimal"},
	STRING:  {Input: []uint16{}, Output: []uint16{}, Literal: "string"},
}
